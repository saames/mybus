...
class CriarLinhaView:
    def __init__(self, master, janela_origem):
        ...
        # Número da rota
        self.lbl_number = ttk.Label(self.frm_center, text='Número:',font=('TkDefaultFont', 10, 'bold'))
        self.lbl_number.grid(column=0, row=3,sticky='w', pady=(0, 2))
        ...
        self.spb_number.grid(column=0, row=4, sticky='ew', pady=(0,15))
